...
@TeleOp(name="Mecanum Drive without sweeper")
public class MecanumDriveWithoutSweeper extends RobotAutoDriveByGyro_Linear {
    ...
    private Servo pincherServo, leftSweeperServo, rightSweeperServo;
    ...
    public void runOpMode() {
        ...
        leftSweeperServo = hardwareMap.get(Servo.class, "sweeper_servo1");
        rightSweeperServo = hardwareMap.get(Servo.class, "sweeper_servo2");
        ...
        while (opModeIsActive()) {
            ...
            if(!gamepad1.dpad_up) {
                ...
                if (gamepad2.left_bumper) {
                    leftSweeperServo.setPosition(0);
                    rightSweeperServo.setPosition(1);
                } else if (gamepad2.right_bumper) {
                    leftSweeperServo.setPosition(0.5);
                    rightSweeperServo.setPosition(0.7);
                }
                ...
                telemetry.addData("Left Sweeper Pos.", leftSweeperServo.getPosition());
                telemetry.addData("Right Sweeper Pos.", rightSweeperServo.getPosition());
            ...
            if (chars[0] == '[') {
                switch (chars[1]) {
                    case '↕':
                        ...
                        sleep(Long.parseLong(extractString(instructions.get(i), ',', 4))/1000);
                    ...
                    case '↔':
                        ...
                        turn = 0;
                        telemetry.addData("string", extractString(instructions.get(i), ',', 3));
                ...
                leftSweeperServo.setPosition(0); // spin forward
                rightSweeperServo.setPosition(1); // spin forward
            } else if (chars[0] == '↻') {
                leftSweeperServo.setPosition(0.5); // spin forward
                rightSweeperServo.setPosition(0.7);
            }
        }
    }
     ...
     */
    private String extractString(String string, char separator, int section) throws IndexOutOfBoundsException {
        if (section < 1) {
     ...
     */
    private double[] calcDrivePowers(double fb, double strafe, double turn, double drivePowerMax) {
